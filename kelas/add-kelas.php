        ...
        <div class="container-fluid px-4">
            ...
            <div class="card">
                <div class="card-header">
                    <span class="h5 my-2"><i class="fa-solid fa-square-plus"></i> Tambah Kelas</span>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <select name="jurusan" id="jurusan" class="form-select border-0 border-bottom ps-2" required>
                                            ...
                                            <option value="Kimia Industri" id="kimia-industri">Kimia Industri</option>
                                            <option value="Kimia Analis" id="kimia-analis">Kimia Analis</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="mb-3 row">
