...
$title = "Data Ujian - Pondok Informatika";
...
<div id="layoutSidenav_content">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="dropdown" style="margin-top: -30px;">
                        <button class="btn btn-sm btn-primary dropdown-toggle float-end" type="button" data-bs-toggle="dropdown"></i>Cetak</button> 
                        <ul class="dropdown-menu">
                            <li><button type="buton" onclick="printDoc()" class="dropdown-item"><i class="fa-solid fa-magnifying-glass"></i> Hasil Ujian</button></li>
                            <li><hr class="dropdown-divider"></li>
                            <li>
                            <button type="buton" class="dropdown-item" data-bs-toggle="modal" data-bs-target="#mdlCetak"><i class="fa-solid fa-magnifying-glass"></i> Nilai Ujian</button>
                            </li>
                        </ul>
                    </div>
                </div>
    ...
    <script>
        function printDoc(){
            const myWindow = window.open("../report/r-ujian.php", "", "width=900,height=600,left=50");
        }
