...
<html lang="en">
    <head>
        ...
        <title>Login - Pondok Informatika</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h4 class="text-center font-weight-light my-4">Login - Pondok Informatika</h4></div>
                                    <div class="card-body">
                                        <form action="proseslogin.php" method="POST">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="username" name="username" type="text" pattern="[A-Za-z0-9]{3,}" title="kombinasi angka dan huruf minimal 3 karakter" 
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="text-muted smal">Copyright &copy; Pondok Informatika <?= date('Y') ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
