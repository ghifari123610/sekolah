...
<div style="text-align: center">
    ...
    <h2 style="margin-bottom: 15px">Pondok Informatika</h2>
</div>
    ...
    <table>
        <thead>
            ...
            <tr>
                <td colspan="7">
                    <hr style="margin-bottom: 2px; margin-top: 1px; margin-left: -5px;", size="3" color="gray">
                </td>
            </tr>
        </thead>
        <tbody>
        ...
        <tfoot>
            <tr>
                <td colspan="7">
                    <hr style="margin-top: 1px; margin-bottom: 2px; margin-left: -5px" size="3" color="gray">
                    <p>Makassar, <?= date('j F Y') ?></p>
                    <p>Dibuat Oleh, <b>SANTRI PONDOK INFORMATIKA</b></p>
                </td>
            </tr>
        </tfoot>
    </table>
